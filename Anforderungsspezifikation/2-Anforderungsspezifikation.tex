...
1.4 & 03.11.2014 & Anwendungsfälle \ref{subsubsec:LehrerinHinzufuegen}, \ref{subsubsec:LehrerinBearbeiten}, \ref{subsubsec:LehrerinLoeschen}, \ref{subsubsec:PaedMitarbeiterinHinzufuegen}, \ref{subsubsec:PaedMitarbeiterinBearbeiten} und \ref{subsubsec:PaedMitarbeiterinLoeschen} (noch ohne Aktionen) hinzugefügt.
\end{tabularx}
...
\textbf{Varianten}
\fboxrule1mm
\definecolor{rahmen}{cmyk}{.4,1,1,0}      % hellgruener Rahmen
\begin{enumerate}
\item \fcolorbox{rahmen}{white}{zu 10: Frau Meyer möchte sich dem ganzen dritten Jahrgang zuordnen.} [Muss noch besprochen werden, wie dies geschehen soll.]
...
Analog zu Anwendungsfall \ref{subsubsec:LehrerinHinzufuegen}, wobei der Akteur in Schritt 2 nicht auf ,,Lehrer``, sondern ,,Päd. Mitarbeiter`` klickt. Außerdem werden die Wochenstunden in Zeitstunden angegeben und mögliche Stundeninhalte sind keine Schulfächer.


\subsubsection{Pädagogische Mitarbeiterin bearbeiten}
\label{subsubsec:PaedMitarbeiterinBearbeiten}
Analog zu Anwendungsfall \ref{subsubsec:LehrerinBearbeiten} mit in \ref{subsubsec:PaedMitarbeiterinHinzufuegen} genannten Abweichungen. Vorbedingung ist allerdings nicht, dass eine Lehrerin existiert, sondern eine päd. Mitarbeiterin.


\label{subsubsec:PaedMitarbeiterinLoeschen}
\subsubsection{Pädagogische Mitarbeiterin löschen}
Analog zu Anwendungsfall \ref{subsubsec:LehrerinLoeschen}, wobei der Akteur in Schritt 2 nicht auf ,,Lehrer``, sondern ,,Päd. Mitarbeiter`` klickt und dementsprechend eine Liste von allen existierenden pädagogischen Mitarbeitern sieht. Vorbedingung ist auch hier nicht, dass eine Lehrerin existiert, sondern eine päd. Mitarbeiterin.
