...
\item Machen Sie alle weiteren Angaben. Gehen Sie möglichst von oben nach unten vor.\medskip\\
    ...
    \end{minipage} 
    \medskip
\item Klicken Sie anschließend auf Hinzufügen. Wenn das Hinzufügen erfolgreich ist, wird der Dialog geschlossen und Sie erhalten eine entsprechende Nachricht. %TODO: Erweitern, aktualisieren
\end{enumerate}
