...
1.4 & 06.02.2015 & Einflussfaktoren und Problemkarten, Modulsicht, und Sequenzdiagramme erweitert\\
\end{tabularx}
...
\multicolumn{2}{|l|}{\textbf{Verwendete Strategie(n)}} \\\hline
 \textbf{ S1 Schrittweiser Aufbau} \newline
 
  \textbf{S2 Regelmäßige Reevaluierung}
    & Es werden beide aufgelistete Strategien gewählt, um die Mindestanforderungen möglichst schnell und gut zu erfüllen. \\\hline
\end{tabularx}
\newpage
...
\item[P2.2] Vorwissen des Benutzers
 ...
 \hline
 \multicolumn{2}{|l|}{\textbf{Lösungen}} \\\hline
\textbf{S11 Verwendung eines Frameworks} & Es kann ein vorhandenes Framework, für Java beispielsweise die JavaServer Faces (bzw. Primefaces), Swing, JavaFX für die Lösung dieses Problems gewählt werden. Damit können viele Probleme der Anzeige gelöst werden.\\\hline
\multicolumn{2}{|l|}{\textbf{Verwendete Strategie(n)}} \\\hline
\textbf{S11 Verwendung eines Frameworks} & Für die Lösung dieses Problems wäre JavaServer Faces die geeignete Wahl. Das bereits bestehende Vorwissen sowie mögliche Ansprechpartner machen den umgang mit JavaServer Faces einfach als mit Swing oder JavaFX. Interne Schulungen können so besser umsetzbar. \\\hline
\end{tabularx}
...
Vorraussetzung wäre das Nachpflegen eines entsprechenden Parameters an den Personal-Objekten.\\

\item Anrechenbare Ersatzleistungen des Personals umsetzen.\\
Da sich die interaktive Planungsansicht des Systems nur auf eine Woche bezieht, würden die anzurechnenden Ersatzleistungen sinnvollerweise in einem wöchentlichen Wert o.ä. angegeben werden, wodurch dies nur als Parameter an der Personal-Objekten nachgepflegt und von der Gesamtstundenzahl einer Lehrkraft aus programmiertechnischer Sicht abgezogen werden müsste.\\
