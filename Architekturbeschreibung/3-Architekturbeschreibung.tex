...
5	& Schoolclass -- Subject 				& Eine beliebige Anzahl an Schulklassen hat Bedarf an 
	einer beliebigen Anzahl von Schulfächern. Die Anzahl an Schulfächern darf beliebig sein, damit eine Klasse auch erstellt werde kann, wenn noch keine Schulfächer existieren. Der Bedarf wird über die Assoziationsklasse \texttt{SubjectDemand} dargestellt.\\\hline
...
9 	& Activity -- Employee					& Eine beliebige Anzahl von Aktivitäten besitzt 
	eine beliebige Anzahl von Personen des Personals als Teilnehmer. Die Assoziation wird mittels der Assoziationsklasse \texttt{EmployeeTimePeriods} hergestellt. Diese ordnet einem Mitarbeiter (\textit{Employee}) eine Liste von Zeiträumen (TimePeriod-Objekten) zu. \\\hline
...
12	& \textit{ActivityType} -- Room					& Einem beliebigen Anzahl von Aktivitätstypen
...
Abbildung 3 zeigt eine Übersicht über die verschiedenen Datenklassen mit ihren Attributen. 
